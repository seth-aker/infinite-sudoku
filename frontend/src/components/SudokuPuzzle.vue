...
<template>
  <div
    class="relative bg-black flex items-center justify-center mb-4"
    :style="{
      height: `${PUZZLE_SIZE + GAP_PX * 2}px`,
      width: `${PUZZLE_SIZE + GAP_PX * 2}px`,
    }"
  >
    <div
      class="relative bg-gray-500 dark:bg-background"
      ...
      >
        <div class="relative h-full w-full">
          <Cell
            ...
            "
            :style="{ left: getBlockSpacing(columnIndex) }"
            class="absolute"
            :cell="cell"
            :width="CELL_SIDE"
          />
